...
// import * as ReactLoadindSkeleton from 'react-loading-skeleton';
...
class Skeletor extends React.Component<IProps, IState> {
...
class CardContent extends React.Component<ICardProps> {
  render() {
    return (
